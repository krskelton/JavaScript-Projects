...
let activePlayer = "X";
// This array stores an array of SVGPathSegMovetoAbs. We use this to determine win conditions
selectedSquares = [];
...
function placeXOro(squareNumber){
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))){
        ...
        if (activePlayer === 'X'){
            // If activePlayer is equal to 'X', the XMLDocument.png is placed in HTML 
        ...
        if (activePlayer === 'O'){
            ...
            disableClick();
            //This function waits 1 second before placing the iage and enabling click
            setTimeout(function (){computersTurn();}, 1000);
        }
        //Returning true id needed for our computersTurn() function to work
        return true;
    }
...
function checkWinConditions(){
    ...
    //This condition checks for tie. If none of the above conditions register and 9 squares are selected, the code executes
        ...
        //Thids function plays the tie game sound
...
//This function the game in a tie or a win
function resetGame(){
